...
static LvArray::Array< std::string, 1, RAJA::PERM_I, std::ptrdiff_t, LvArray::MallocBuffer > arr( ARR_SIZE );
...
getarray( PyObject *self, PyObject *args )
{
    ...
    return LvArray::python::create( arr.toView(), true );
}
...
getvector( PyObject *self, PyObject *args )
{
    LVARRAY_UNUSED_VARIABLE( self );
    LVARRAY_UNUSED_VARIABLE( args );
    return LvArray::python::create( vec, true );
}
